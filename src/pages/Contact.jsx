    ...
    <section className='relative flex lg:flex-row flex-col max-container font-sans text-blue-300'>
      ...
      <div className='flex-1 min-w-[50%] flex flex-col'>
        ...
        >
          ...
          <label className=' font-bold text-xl '>
            Email
            <input type="email" name="email" className='input' placeholder='John Doe' required value={form.email} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur}/><p></p>
          </label>
